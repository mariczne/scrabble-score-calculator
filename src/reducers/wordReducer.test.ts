...
describe("wordReducer", () => {
  ...
  it("should handle INCREMENT_TILE_MULTIPLIER action", () => {
    const bonuses = [{ type: BonusType.Tile, index: 2, multiplier: 2 }];
    const action = {
    ...
    expect(wordReducer({ ...mockState, bonuses }, action)).toEqual(
      expectedState
    );
  });

  it("should handle ADD_WORD_MULTIPLIER action", () => {
    const bonuses = [{ type: BonusType.Tile, index: 2, multiplier: 3 }];
    const action = {
  ...
  it("should handle INCREMENT_WORD_MULTIPLIER action", () => {
    const bonuses = [{ type: BonusType.Word, index: 2, multiplier: 2 }];
    const action = {
  ...
  it("should handle REMOVE_WORD_MULTIPLIER action", () => {
    const bonuses = [{ type: BonusType.Word, index: 2, multiplier: 3 }];
    const action = {
